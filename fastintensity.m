function fastintensity(thatpath,cellmaskTmem119)
SE=strel('disk',8);
...
%imshow(cellMask);
Gabbr2_1_3=myHighPass(imread(fullfile(mypath,'mosaic_bit13_compiled.tif')));
%imwrite(imresize(Gabbr2_1_3,10),fullfile(mypath,'filteredsmFISHGabbr2_1.png'));
Gabbr2_2_3=myHighPass(imread(fullfile(mypath,'mosaic_bit14_compiled.tif')));
%imwrite(imresize(Gabbr2_2_3,10),fullfile(mypath,'filteredsmFISHGabbr2_2.png'));
Tspan7_1_3=myHighPass(imread(fullfile(mypath,'mosaic_bit15_compiled.tif')));
%imwrite(imresize(Tspan7_1_3,10),fullfile(mypath,'filteredsmFISHTspan7_1.png'));
Tspan7_2_3=myHighPass(imread(fullfile(mypath,'mosaic_bit16_compiled.tif')));
%imwrite(imresize(Tspan7_2_3,10),fullfile(mypath,'filteredsmFISHTspan7_2.png'));
C1qc_3=myHighPass(imread(fullfile(mypath,'mosaic_bit17_compiled.tif')));
%imwrite(imresize(C1qc_3,10),fullfile(mypath,'filteredsmFISHC1qc.png'));
Tms4bx_3=myHighPass(imread(fullfile(mypath,'mosaic_bit18_compiled.tif')));
%imwrite(imresize(Tms4bx_3,10),fullfile(mypath,'filteredsmFISHTms4bx.png'));
Rps29_3=myHighPass(imread(fullfile(mypath,'mosaic_bit19_compiled.tif')));
%imwrite(imresize(Rps29_3,10),fullfile(mypath,'filteredsmFISHRps29.png'));
Ftl1_3=myHighPass(imread(fullfile(mypath,'mosaic_bit20_compiled.tif')));
%imwrite(imresize(Ftl1_3,10),fullfile(mypath,'filteredsmFISHFtl1.png'));
mt_Nd2_3=myHighPass(imread(fullfile(mypath,'mosaic_bit21_compiled.tif')));
%imwrite(imresize(mt_Nd2_3,10),fullfile(mypath,'filteredsmFISHmt_Nd2.png'));
mt_Co3_3=myHighPass(imread(fullfile(mypath,'mosaic_bit22_compiled.tif')));
